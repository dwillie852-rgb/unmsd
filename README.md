...
Static website prototype for a humanitarian medical relief organisation with programmes, field operations, support pathways, accountability, staff care, and a dedicated leave relief application page.

## Open locally

Open `index.html` directly in a browser, or serve the folder for local testing:
...
The visual direction was informed by the public MSF website structure and tone, while avoiding use of MSF logos, copy, or brand assets. The local images in `assets/` were downloaded from Unsplash photo URLs used in the prototype.
